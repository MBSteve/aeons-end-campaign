...
def compare_images(image_a_path: str, image_b_path: str, api_key: str) -> str:
    ...
    comparison_prompt = (
        ...
        "- Photorealistic high-end fantasy game cinematic\n"
        "- Grounded medieval Gothic setting\n"
        "- Mature naturalistic character design with realistic ageing and skin texture\n"
        "- Weathered layered fabrics and tarnished metal\n"
        "- Restrained practical costume — no exaggerated armour\n"
        "- Dramatic chiaroscuro lighting (Rembrandt-style)\n"
        "- Warm candlelight against cool ambient shadows\n"
        "- Muted charcoal and earthy colour palette — no saturated colours\n"
        "- Subtle atmospheric haze, shallow depth of field\n"
        "- Tactile, weathered materials\n"
        "- Sombre dignified mood\n"
        "- AVOID: steampunk, anime, comic book, digital painting, hand-drawn illustration, "
        "glossy plastic skin, beauty retouching, exaggerated armour, heroic poses, "
        "saturated colours, bright daylight, flat lighting, generic fantasy illustration\n\n"
        ...
        "1. **Overall Style Match**: Is Image B cinematic dark-fantasy realism, or does it lean toward illustration / painting / anime / comic book / steampunk?\n"
        "2. **Realism & Texture**: Does Image B have photorealistic skin, fabric, and materials, or does it look painted/illustrated?\n"
        "3. **Colour Palette**: Does Image B use muted charcoal and earthy tones, or are there saturated/neon colours?\n"
        "4. **Lighting**: Is the lighting dramatic chiaroscuro with warm light against cool shadows, or is it flat/bright/artificial?\n"
