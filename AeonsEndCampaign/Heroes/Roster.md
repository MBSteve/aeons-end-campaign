...
The active roster of Breach Mages available for missions.

---

## Available Mages (Not Yet Activated)

These mages are available for nomination. Only mages that have been selected for at least one mission appear in the Active Mages table below.
...
- **Nemeses defeated**: Rageborne
- **Times exhausted**: 0
- **Heroic moments**: Provided steady damage throughout the battle; his Amplify Vision build was interrupted but he adapted and contributed consistently.
- **Titles earned**: None
- **Experience (XP)**: 2 (mission completed + victory)
- **Permanent perks**: None
- **Injuries or scars**: None
- **Relationships**: Fought alongside Kadir and Xaxos at the East Gate.
- **Retirement status**: Active

### Kadir
- **Missions played**: 1 (S01)
- **Victories / Defeats**: 1 / 0
- **Nemeses defeated**: Rageborne (killing blow)
- **Times exhausted**: 1
- **Heroic moments**: Dealt the killing blow to Rageborne while exhausted — a final act of defiance from a mage who had given everything. Her emerald shard flared one last time as she fell.
...
- **Nemeses defeated**: Rageborne
- **Times exhausted**: 0
- **Heroic moments**: Unleashed a devastating barrage of 16 damage in a single turn — a torrent of flame that seared through Rageborne's hide and turned the tide of battle.
- **Titles earned**: None
- **Experience (XP)**: 2 (mission completed + victory)
- **Permanent perks**: None
- **Injuries or scars**: None
- **Relationships**: Fought alongside Adelheim and Kadir at the East Gate.
- **Retirement status**: Active

---

*This file is updated after every mission in which a mage participates.*
