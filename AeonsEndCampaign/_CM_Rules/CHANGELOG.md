...
### Fixed (Post-Mission Validation)
- **CampaignState.yaml**: Rageborne and Carapace Queen were still listed in `nemeses.available` alongside `nemeses.defeated` — removed from available
